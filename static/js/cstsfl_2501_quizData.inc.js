...
var cstsfl_2501_quizData = [
    {
        ...
        "question_sub": "&nbsp;&nbsp;김 선임은 테스터가 등록한 결함을 분석하는 중이다. 하지만 테스터가 등록한 테스트 케이스로는 아무리 재현하려고 해도 재현이 되지 않았다. 시간은 흐르고 결함 해결 기간은 계속 길어졌다. 개발자의 개발환경에서는 재현이 되지 않아 테스터에게 로그를 요청했다. 로그를 보니 테스터는 해당 테스트를 실제 운영 환경에서 테스트를 한 것이었다. 개발자는 테스터에게 아직 기능 구현이 완료되지 않아 운영 환경에서 동작하는 일부 기능은 막아둔 상태이므로 시뮬레이션 환경에서 테스트를 해 볼 것을 요청했다. 테스터는 개발자와 동일한 환경에서 테스트 하자 결함이 발생하지 않는 것을 확인했다. ",
        "explanation": "",
        "options": [
    ...
    },
    {
        ...
        "question_sub": "&nbsp;&nbsp;가) 시스템이 다른 하드웨어, 소프트웨어 혹은 기타 사용 환경에 효과적이고 효율적으로 적용될 수 있는 정도<br>&nbsp;&nbsp;(나) 특정 환경에서 시스템을 성공적으로 설치 및 제거할 수 있는 정도<br>&nbsp;&nbsp;(다) 시스템이 동일한 환경에서 동일한 목적을 위해 지정된 소프트웨어 제품으로 대체 될 수 있는 정도", 
        "explanation": "",
        "options": [
    ...
    {
        "type": "radio",
        "question": "다음은 구조기반 테스트 커버리지에 대한 설명이다. 어떤 테스트 커버리지와 관련이 있는지 고르시오.[FL-2501-27.jpg]",
        "explanation": "",
        "options": [
    ...
    {
        "type": "radio",
        "question": "다음 설명에 맞는 테스트 설계 기법은 무엇인가?[FL-2501-28.jpg]",
        "explanation": "",
        "options": [
    ...
    {
        "type": "radio",
        "question": "다음 명세에 대해 동등 분할 테스트를 수행할 때 선정되는 가장 적절한 테스트 데이터는 무엇인가?[FL-2501-29.jpg]",
        "explanation": "",
        "options": [
    ...
    {
        "type": "radio",
        "question": "다음은 소포 요금을 계산하는 시스템에 대한 명세이다. 경계값 분석을 통하여 선정되는 테스트 입력 값들로 가장 가능성이 높은 것은 무엇인가?[FL-2501-30.jpg]",
        "explanation": "",
        "options": [
    ...
    {
        "type": "radio",
        "question": "<보기>의 명세를 기반으로 테스트 케이스를 생성하기 위해 결정표 테스트를 작성하였다. 이때 결정된 조건으로 올바르지 않은 것은?[FL-2501-32.jpg]",
        "explanation": "",
        "options": [
    ...
    {
        "type": "radio",
        "question": "휴대폰 번호 10자리를 입력 받는 입력 항목에 대해 오류 추정을 적용하여 테스트하려고 한다. 이 때 테스트할 수 있는 항목을 모두 고른 것은?[FL-2501-34.jpg]",
        "explanation": "",
        "options": [
            { "value": "① (가)", "right": false },
            { "value": "② (가), (나)", "right": false },
    ...
    {
        "type": "radio",
        "question": "다음 보기의 설명에 부합하는 테스트 설계기법은 무엇인가?[FL-2501-42.jpg]",
        "explanation": "",
        "options": [
            { "value": "① 워크쓰루(Walk-through)", "right": false },
    ...
    {
        "type": "text",
        "question": "시스템 처리 능력 이상의 부하를 가하여 비정상적인 상황에서의 처리가 적절히 수행되는지 확인하는 테스트를 무엇이라 하는가?&nbsp;&nbsp;&nbsp;&nbsp;(______) 테스트",
        "explanation": "스트레스 | Stress",
        "correct": ["스트레스", "Stress", "stress"]
    },
    {
        "type": "text",
        "question": "다음 괄호 안에 들어갈 알맞은 테스팅 방법을 기술하시오.<br>[FL-2501-64.jpg]",
    ...
    {
        "type": "text",
        "question": "<보기>의 수식은 (______) 커버리지를 구하기 위한 계산법이다.<br>[FL-2501-67.jpg]",
        "explanation": "다중 조건",
        "correct": "다중 조건"
    },
    {
        "type": "text",
        "question": "다음 괄호 안에 알맞은 테스트 활동을 기재하시오.<br>[FL-2501-68.jpg]",
        "explanation": "테스트 종료 | 테스트 완료",
        "correct": ["테스트 종료", "테스트 완료"]
    },
    {
        "type": "text",
        "question": "다음 테스트 환경구축 및 관리 활동에서 아래에 해당되는 산출물의 명칭을 기재하시오.<br>[FL-2501-69.jpg]",
        "explanation": "테스트 환경 준비 보고서",
        "correct": "테스트 환경 준비 보고서"
    },
    {
        "type": "text",
        "question": "다음의 보기에서 설명하는 활동은 테스트 프로세스의 어느 단계에 해당하는가?<br>[FL-2501-70.jpg]",
        "explanation": "테스트 종료",
        "correct": "테스트 종료"
    }
];
