...
{
    "type": "radio",
    "question": "6. 다음에서 설명하고 있는 용어는 무엇인가? \n '<'상향식 테스트에서 아직 통합되지 않은 상위 컴포넌트의 동작을 시뮬레이션하는 모의 모듈로 테스트를 위한 인터페이스를 제공하는 형태로 구현된다.'>'",
    "explanation": "",
    "options": [
...
{
    "type": "radio",
    "question": "15. 다음은 프로그램을 얼마나 손쉽게 테스트할 수 있는지를 나타내는 테스트 용이성을 나타내는 특성들과 그에 대한 설명들이다. 특성과 설명이 올바르게 연결된 것은?",
    "explanation": "",
    "options": [
...
{
    "type": "radio",
    "question": "25. <보기> 코드를 정적 분석했을 때 발견되는 문제점의 유형은 무엇인가?",
    "explanation": "",
    "options": [
...
{
    "type": "radio",
    "question": "28. <보기>의 제어 흐름 그래프에서 문장 커버리지 100%를 만족시키는 테스트 케이스는?",
    "explanation": "",
    "options": [
...
{
    "type": "radio",
    "question": "29. <보기>의 프로그램 코드에서 결정 커버리지 100%를 만족하기 위한 최소 테스트 케이스의 수는 몇 개인가?",
    "explanation": "",
    "options": [
...
{
    "type": "radio",
    "question": "31. 다음 소스 코드에 대하여 100% 다중 조건 커버리지를 만족하는 최소의 테스트 케이스 개수는 몇 개인가?",
    "explanation": "",
    "options": [
           {"value": "2",  "right": false}, 
           {"value": "4",  "right": false},
...
{
    "type": "radio",
    "question": "33. 다음 중 입력 인자와 클래스의 개수가 <보기>와 같을 때, 테스트 케이스가 가장 많이 생성되는 조합 테스트 방법은 무엇인가?",
    "explanation": "",
    "options": [
...
{
    "type": "radio",
    "question": "35. 시스템의 상태 전이도를 기반으로 테스트 케이스를 도출하는 절차로 올바른 것은?",
    "explanation": "",
    "options": [
           {"value": "(가) → (나) → (다) → (라)",  "right": false}, 
...
{
    "type": "radio",
    "question": "38. 테스트 프로세스에 따른 문서의 산출물 순서가 올바른 것은 무엇인가?",
    "explanation": "",
    "options": [
...
{
    "type": "radio",
    "question": "42. 다음 중에서 테스트 완료 기준으로 사용되는 예를 모두 고른 것은?",
    "explanation": "",
    "options": [
           {"value": "(가)",  "right": false}, 
...
},
{
    "type": "radio",
    "question": "",
    "explanation": "43. 다음의 보기는 테스트 활동의 수행할 역할별로 인력을 정의한 예시이다. 역할이 틀리게 지정된 것은 무엇인가?",
    "options": [
