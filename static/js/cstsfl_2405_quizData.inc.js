...
var cstsfl_2405_quizData = [
    ...
    },
    {
        ...
        "question_sub": "<다음>(&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;) 테스팅은 소프트웨어 변경이 발생한 후에 수행되는 테스트로 소프트웨어에 가해진 변경이 의도하지 않은 결함을 만들지 않았으며 시스템이 기존의 요구사항을 충족함을 검증하기 위하여 수행하는 테스트이다.",
    ...
    },
    {
        ...
        "question_sub": "<다음>입력값, 테스트 절차, 테스트 환경 중에 어떤 요소가 결함 발생에 영향을 미치는지 분석하여 결함 발생의 구체적인 상황을 파악하는 방법을 결함의 (&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;) 라고 한다.",
